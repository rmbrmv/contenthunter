...
## Не вошло в скоуп (осознанно) → бэклог WP#227
...
- Замедление тест-набора от реальных `time.sleep` в поллинге (инъекция sleep/часов для тестируемости).

Оба вынесены в OpenProject **WP#227** (Бэклог, follow-up WP#225).
